...
const RegistrationForm = () => {
    const [typeRegister, setTypeRegister] = useState('employers');
                    ...
                    <div className="login__radio">
                        ...
                        <div className="login__radio-inputs">
                            <div className="login__input input">
                                <input onInput={editTypeRegister} value={"employers"} className="input__input  _radio"
                            ...
                            <div className="login__input input">
                                <input onInput={editTypeRegister} value={"applicants"}
